    ...
    >
      ...
      <div className="stay-card-img">
        <img
          ...
          onError={e => {
            ...
            e.currentTarget.src =
              'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=640&q=75&auto=format'
          }}
        />
        ...
        >
          <span style={{ color: '#F59E0B', fontSize: '0.75rem', display: 'flex' }}>
            <FiStar />
          </span>
      ...
      >
        <div>
          ...
          <h3 className="heading-sm" style={{ color: 'var(--hill-navy)' }}>
            {stay.name}
          </h3>

          <p className="body-sm" style={{ color: 'var(--hill-muted)', marginTop: '0.4rem' }}>
            {stay.description}
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
          ...
          {stay.amenities.length > 3 && (
            <span style={{ fontSize: '0.6rem', color: 'var(--hill-muted)' }}>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 'var(--container-w)', margin: '0 auto' }}>
        ...
        {/*
          HOME PAGE ONLY:
          HorizontalCarousel will show left/right navigation arrows.

          OFFICIAL STAYS PAGE / OTHER ROUTES:
          Normal responsive listing grid will be shown without carousel arrows.
        */}
        {isHomePage ? (
          <HorizontalCarousel
            items={filtered}
            ariaLabel="Curated stays carousel"
            renderItem={renderStayCard}
          />
        ) : (
          <div
            className="stays-list-grid"
            style={{
              display: 'grid',
          ...
          >
            {filtered.map((stay, i) => renderStayCard(stay, i))}
          </div>
        )}
      </div>
    </section>
